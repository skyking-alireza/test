...
import Notification from "../../assets/Notification 1.svg"
import Headphone from "../../assets/Headphone 1.svg"
  ...
  return<div className={"bg-white px-5 flex items-center justify-between py-3.5 gap-x-3.5"}>
      <div className={"flex gap-x-3 items-center justify-between text-[18px] font-medium"}>
          <Link to={"/support"} >
              ...
              <p className={"text-[#93949D]"}>پشتیبانی</p>
          </Link>
          <Link to={"/notifications"} >
              ...
              <p className={"text-[#10A5E7]"}>اعلان ها</p>
          </Link>
      </div>
